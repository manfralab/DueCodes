...
def _empty_dataset_dict(dataset: DataSet):
    ...
    return {
        "independent_parameters": {
            "names": independent_params,
            "units": independent_units,
            "shape": [None] * len(independent_params),
            "data": [None] * len(independent_params),
        },
        "dependent_parameters": {
            "names": dependent_params,
            "units": dependent_units,
            "shape": [None] * len(dependent_params),
            "data": [None] * len(dependent_params),
        },
        "num_points": dataset.number_of_results,
        "sweep_type": sweep_type,
        "runtime": (dataset.run_timestamp(), dataset.completed_timestamp()),
    }
...
def get_dataset_description(identifier: Union[int, str]) -> dict:
    ...
    del (
        dataset_dict["independent_parameters"]["shape"],
        dataset_dict["independent_parameters"]["data"],
        dataset_dict["dependent_parameters"]["shape"],
